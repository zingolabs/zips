...
Transfer Protocol
  A specification of how a Sender can transact with a Consumer.
...
- Provide forward compatibility that is standard for all wallets across a
  ...
  exchange.
- The standard should work well for Zcash today and upcoming 
  upgrades, and anticipate broader use cases down the road such
